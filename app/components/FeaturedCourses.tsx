...
import CouresData from "@/app/data/subject_courses.json"
...
export default function FeaturedCourses() {
  const featuredCourses = CouresData.courses.filter((course:Courses) => course.isFeatured)
  return (
    <div className="py-12 bg-gray-900">
        <div>
            <div className="text-center">
                <h2 className="text-base text-teal-600 font-semibold tracking-wide">FEATURED COURESES</h2>
